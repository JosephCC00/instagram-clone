              ...
              <div>
                {selectedFile ? (
                  <img
                    ...
                    onClick={() => {
                      setSelectedFile(null);
                      // must clear input value because onChange only works if a different file is selected
                  ...
                  <div
                    // we are basically executing a fake click on the hidden input field here
